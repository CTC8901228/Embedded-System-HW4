...
public:
    ...
    void updateHeartRate(int16_t* hrmCounter) {
        ...
        bool p=true;
        // ble.gattServer().areUpdatesEnabled(hrmRate.getValueHandle(),hrmRate,&p);
        // printf("%d",p);
        // hrmRate.set(ble.gattServer(),hrmCounter);
...
protected:
    ...
    struct HeartRateValueBytes {
        ...
        static const unsigned MAX_VALUE_BYTES = 66;
